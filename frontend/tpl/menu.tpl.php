...
<?php if($conf->global->POS_RESTAURANTE){ ?>
...
?>
<li><a class="collapsible-header waves-effect" href="product_list.php?fk_cierre=<?php echo $control->id ?>">Listado de productos</a></li>              
...
<div id="caja_info">
    ...
    <nav class="navbar fixed-top navbar-toggleable-md navbar-expand-lg scrolling-navbar double-nav">
      ...
      <ul class="navbar-nav ml-auto nav-flex-icons">
            ...
            <li class="nav-item" data-toggle="tooltip" data-placement="bottom" title="Separar en en otra factura">
                <a id="separar" class="nav-link waves-effect waves-light">
                <i class="far fa-object-ungroup fa-2x"></i>
              </a>
              </li>     

            <li class="nav-item" data-toggle="tooltip" data-placement="bottom" title="Dividir lineas en partes iguales">
                <a id="dividir" class="nav-link waves-effect waves-light">
