...
$total_monto += $monto;
$html .= '<tr>';
$html .= '<th align="left">'.$b['label'].'</th>';
$html .= '<th align="left">'.price($monto).'</th>';
$html .= '</tr>';
}
$html .= '<tr">';
$html .= '<th></th>';
$html .= '<th align="left">'.price($total_monto).'</th>';
$html .= '</tr>';
$html .= '</table>';
...
$pagos_efectivo = get_pagos_banco(GETPOST('closeid'),'CRC',$sqls=' AND pa.metodo_pago="LIQ"');
$arqueos = get_arqueos(GETPOST('terminalid'),GETPOST('closeid'));
...
$pagos_tarjeta = get_pagos_banco(GETPOST('closeid'),'CRC',$sqls=' AND pa.metodo_pago="CB"');
$arqueos = get_arqueos(GETPOST('terminalid'),GETPOST('closeid'));
